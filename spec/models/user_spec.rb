...
describe User do
  ...
  describe "password validations" do
    it "should require a password" do 
      params = @attr.merge(:password => "", :password_confirmation => "")
      User.new(params).should_not be_valid
    end
    
    it "should require a matching password confirmation" do 
      params = @attr.merge(:password_confirmation => "invalid")
      User.new(params).should_not be_valid
    end
    
    it "should reject short passwords" do
      short = "a" * 5
      params = @attr.merge(:password => short, :password_confirmation => short)
      User.new(params).should_not be_valid
    end
    
    it "should reject long passwords" do
      long = "a" * 41
      params = @attr.merge(:password => long, :password_confirmation => long)
      User.new(params).should_not be_valid
    end
  end
  ...
  context "micropost associations" do
    ...
    describe "status feed" do
      ...
      it "should include the microposts of followed users" do
        ...
        mpost = Factory(:micropost, :user => followed)
        @user.follow!(followed)
        @user.feed.should include(mpost)
      end
    end
  end
end
